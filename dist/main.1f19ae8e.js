...
var _default = {
  ...
  methods: {
    onSelect: function onSelect(rowsIndex, colsIndex) {
  ...
  watch: {
    states: function states(newStates, oldStates) {
      console.log(newStates, oldStates);
    }
  }
};
exports.default = _default;
        var $83c387 = exports.default || module.exports;
      
      if (typeof $83c387 === 'function') {
        $83c387 = $83c387.options;
      }
    
        /* template */
        Object.assign($83c387, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h1", [_vm._v("マルバツゲーム App")]),
    _vm._v(" "),
    _c(
      "table",
      { attrs: { id: "table" } },
      _vm._l(_vm.states, function(row, rowsIndex) {
        return _c(
          "tr",
          { key: rowsIndex },
          _vm._l(row, function(state, colsIndex) {
            return _c(
              "td",
              {
                key: colsIndex,
                on: {
                  click: function($event) {
                    return _vm.onSelect(rowsIndex, colsIndex)
                  }
                }
              },
              [
                state == 1
                  ? _c("div", { staticStyle: { color: "#f00" } }, [_vm._v("○")])
                  : _vm._e(),
                _vm._v(" "),
                state == 2
                  ? _c("div", { staticStyle: { color: "#00f" } }, [_vm._v("×")])
                  : _vm._e()
              ]
            )
          }),
    ...
    _vm._v(" "),
    _c("div", { staticStyle: { "text-aligin": "center" } }, [
      _vm.playerId == 1
        ? _c("div", { staticStyle: { color: "#f00" } }, [
            _vm._v("「○　プレイヤーさん、マスを選んでください。」")
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm.playerId == 2
        ? _c("div", { staticStyle: { color: "#00f" } }, [
            _vm._v("「×　プレイヤーさん、マスを選んでください。」")
          ])
        : _vm._e()
    ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$83c387', $83c387);
          } else {
            api.reload('$83c387', $83c387);
          }
        }
...
},{"vue/dist/vue":"../node_modules/vue/dist/vue.js","./components/App.vue":"components/App.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
